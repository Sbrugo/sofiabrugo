...
export default function App() {
  return (
    <div className="pl-0 md:pl-[50px] lg:pl-[100px]">
      <Sidenav></Sidenav>
      <nav className="p-4 bg-slate-100 text-gray-950 text-xl flex justify-end">
        <ul>
          <li className="text-orange-500">sofia.brugo@hotmail.com</li>
        </ul>
      </nav>
      <div className="min-h-screen p-8 space-y-16 py-30 bg-slate-100 text-gray-950">
        ...
        >
          <div className="flex flex-col">
            <span className="font-mono text-4xl md:text-7xl font-bold">
              Hi,
            </span>
          ...
          >
            <span className="font-sans">
              ...
              analysis. <br /> I study Cibersecurity in Palermo University,
              Buenos Aires and know full stack development. <br />
            </span>{" "}
          ...
          >
            ...
            optimization. I specialize in supporting the development of solid,
            scalable systems by prioritizing logical thinking to ensure
            efficiency, clarity, and long-term success from the very beginning
            of each project.
          </motion.p>
        </motion.div>
          ...
          <div className="mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg mb-12">
                ...
                and solved concrete challenges, depending on the project
                purpose. There are links below to every project
              </p>
