...
export const books = [
  ...
  },
  {
    ...
    description_text:
      "Learn not just how to write code but how to think like a programmer. It teaches Python clearly and gradually and helps you see the bigger picture behind the code. Connect the dots between syntax and real problem-solving.",
